...
\addcontentsline{toc}{subsubsection}{Data Augmentation}
...
\addcontentsline{toc}{paragraph}{Scale Parameters}
...
\addcontentsline{toc}{paragraph}{Scale Parameter}
...
\addcontentsline{toc}{paragraph}{Shape Parameter}
...
\addcontentsline{toc}{section}{Appendix B: R Code For Score Function}
...
\addcontentsline{toc}{section}{Appendix C: R Code For Simulation of
Scenarios For Assessing Bootstrapped (BCa) Confidence Intervals}
...
\hypertarget{appendix-e-data-augmentation}{%
\section*{Appendix E: Data
Augmentation}\label{appendix-e-data-augmentation}}
\addcontentsline{toc}{section}{Appendix E: Data Augmentation}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{equal\_reliability\_augmentation \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(df, }\DataTypeTok{R =} \DecValTok{1}\NormalTok{) \{}

\NormalTok{    df.censored \textless{}{-}}\StringTok{ }\NormalTok{df[df}\OperatorTok{$}\NormalTok{delta }\OperatorTok{==}\StringTok{ }\OtherTok{FALSE}\NormalTok{, ]}
\NormalTok{    df \textless{}{-}}\StringTok{ }\NormalTok{df[df}\OperatorTok{$}\NormalTok{delta }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{, ]}
\NormalTok{    C \textless{}{-}}\StringTok{ }\NormalTok{md.tools}\OperatorTok{::}\KeywordTok{md\_decode\_matrix}\NormalTok{(df, }\StringTok{"x"}\NormalTok{)}
\NormalTok{    m \textless{}{-}}\StringTok{ }\KeywordTok{ncol}\NormalTok{(C)}

    \ControlFlowTok{for}\NormalTok{ (k }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{m) \{}
\NormalTok{        obs \textless{}{-}}\StringTok{ }\NormalTok{df[}\KeywordTok{sample}\NormalTok{(}\KeywordTok{nrow}\NormalTok{(df), R, }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{), ]}
\NormalTok{        obs[, }\KeywordTok{paste0}\NormalTok{(}\StringTok{"x"}\NormalTok{, }\DecValTok{1}\OperatorTok{:}\NormalTok{m)] \textless{}{-}}\StringTok{ }\OtherTok{FALSE}
\NormalTok{        obs[, }\KeywordTok{paste0}\NormalTok{(}\StringTok{"x"}\NormalTok{, k)] \textless{}{-}}\StringTok{ }\OtherTok{TRUE}
\NormalTok{        df \textless{}{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(df, obs)}
\NormalTok{    \}}
    \KeywordTok{rbind}\NormalTok{(df, df.censored)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
