# in this simulation, we have right censoring at 75% quantile of weibull series
# system and a cmoponent cause of failure p = .215. we want to see how well the
# estimator performs in this case as a function of sample size, from n = 20 to n = 220.
...
#set.seed(134849131)
ns <- c(20, 40, 60, 80, 100, 130, 160, 190, 220)
ps <- c(0.215)
qs <- c(0.75)
R <- 200
