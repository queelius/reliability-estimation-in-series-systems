...
In the reduced model, series system to a known distribution, the Weibull distribution, which is particularly useful
for analysis and interpretation, especially in the context of small samples, since instead of
estimating $2m$ parameters we only need to estimate $m+1$ parameters, one shape parameter and
$m$ scale parameters.
...
### Scenario: Assessing the Impact of Right-Censoring on the MLE {{-#sec:effect-censoring}}
...
### Scenario: Assessing the Impact of Sample Size on the MLE {-}
