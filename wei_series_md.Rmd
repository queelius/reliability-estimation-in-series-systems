...
## Component Reliabilities {#sec:reliability}
...
Same if the components have the same scale parameter, then the MTTF increases as the shape
...
```{r exp_weib_haz-2, fig.align="center", fig.width=8, fig.height=4, fig.cap="Two components (in series configuration). All components have the same MTTF. On the top, both components have a similiar aging process. On the bottom, the red component has a burn-in process and the blue component has an aging process.", warning = FALSE, echo = FALSE}
shapes1 <- c(.1, .5)
scales1 <- c(1, 1)
mttf1 <- wei.series.md.c1.c2.c3::wei_mttf(shapes1[1], scales1[1])
mttf2 <- wei.series.md.c1.c2.c3::wei_mttf(shapes1[2], scales1[2])
print(c(mttf1, mttf2))
...
component is the cause of failure for the $i$\textsuperscript{th} series system 
is the probability that a component is the cause of failure of the series system,
which is given by
$$
