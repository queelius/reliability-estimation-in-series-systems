...
```{r samp-size-n-vs-stats-215-shape, fig.cap=c("Sample Size vs Shape CI Statistics (p = 0.215)", "Sample Size (n) vs Coverage Probability, IQR of Bootstrapped CIs and 95% Confidence Band of Shape MLEs for p = 0.215"), fig.align="center", echo = F}
knitr::include_graphics("image/plot-n-vs-stats-p215-shape.pdf")
```


```{r samp-size-n-vs-stats-215-scale, fig.cap=c("Sample Size vs Scale CI Statistics (p = 0.215)","Sample Size (n) vs Coverage Probability, IQR of Bootstrapped CIs and 95% Confidence Band of Scale MLEs for p = 0.215"), fig.align="center", echo = F}
knitr::include_graphics("image/plot-n-vs-stats-p215-scale.pdf")
```



```{r samp-size-n-vs-stats-p333-scale, fig.cap=c("Sample Size vs Shape CI Statistics (p = 0.333)", "Sample Size (n) vs Coverage Probability, IQR of Bootstrapped CIs and 95% Confidence Band of Shape MLEs for p = 0.333"), fig.align="center", echo = F}
knitr::include_graphics("image/plot-n-vs-stats-p333-shape.pdf")
```

```{r samp-size-n-vs-stats-p215-scale, fig.cap=c("Sample Size vs Shape CI Statistics (p = 0.333)", "Sample Size (n) vs Coverage Probability, IQR of Bootstrapped CIs and 95% Confidence Band of Scale MLEs for p = 0.333"), fig.align="center", echo = F}
...
Here, we can see that the coverage probability for the shape parameters is
