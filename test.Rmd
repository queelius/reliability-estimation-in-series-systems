...
$f_{\T_i}(t;\v\theta)$ and likewise for other distribution functions, e.g., its
relability function is denoted by $R_{\T_i}(t;\v\theta)$. If it is clear from the context which
random variable a distribution function is for, we drop the subscripts, e.g., $F(t)$ instead of
$F_{\T_i}(t)$.
