...
==================================
We consider a system composed of $m$ components arranged in a series configuration. Each component and the system only has two possible states, functioning or failed.
...
The probability density function (pdf) of a random lifetime $T$ is denoted by
$f_T(t)$ and may be defined as
$$
    f_T(t) = -\frac{d}{dt} R_T(t).
$$
...
If the $i$\textsuperscript{th} system has the parameter vector $\v\theta$, we denote its pdf by $f_{\T_i}(t;\v\theta)$ and likewise for other distribution functions, e.g., its relability function is denoted by $R_{\T_i}(t;\v\theta)$.
