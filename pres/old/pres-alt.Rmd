...
\note{Analogy: "A chain is only as strong as its weakest link."}

**Useful Abstraction**: Series systems are useful abstractions for many
real systems.
  - A person's mortality as a series system of organs.
