...
```{r title-image, echo=FALSE, out.width='40%', fig.align='center'}
...
- Project: [https://github.com/queelius/reliability-estimation-in-series-systems](https://github.com/queelius/reliability-estimation-in-series-systems)
- R Library: [www.github.com/queelius/wei.series.md.c1.c2.c3](https://github.com/queelius/wei.series.md.c1.c2.c3)
...
knitr::include_graphics("series.png")
```
...
knitr::include_graphics("dep_model.png")
```
...
## Likelihood Contribution: Derivation for Candidate Sets #2
...
```{r fig-scale-tau, echo=F, out.width="60%", fig.align="center"}
knitr::include_graphics("plot-q-vs-scale.1-mle_plot-q-vs-scale.3-mle.png")
...
```{r fig-shape-tau, echo=F, out.width="75%", fig.align="center"}
knitr::include_graphics("plot-q-vs-shape.1-mle_plot-q-vs-shape.3-mle.png")
```
...
```{r fig-tau-cp, echo=F, out.width="55%", fig.align="center"}
knitr::include_graphics("plot-q-vs-cp_q_vs_convergence.png")
```
...
```{r fig-shape-mask, echo=F, out.width="60%", fig.align="center"}
knitr::include_graphics("plot-p-vs-shape.1-mle_plot-p-vs-shape.3-mle.png")
```
...
```{r fig-scale-mask, echo=F, out.width="75%", fig.align="center"}
knitr::include_graphics("plot-p-vs-scale.1-mle_plot-p-vs-scale.3-mle.png")
```
...
```{r fig-mask-cp, echo=F, out.width="55%", fig.align="center"}
knitr::include_graphics("plot-p-vs-cp_p_vs_convergence.png")
```
...
- **MLE Precision**: Decreases with more masking.
- **MLE Bias**:
...
```{r fig-shape-n-vs-scale, echo=F, out.width="55%", fig.align="center"}
knitr::include_graphics("plot-n-vs-scale.1-mle_plot-n-vs-scale.3-mle.png")
```
...
```{r fig-shape-n-vs-shape, echo=F, out.width="80%", fig.align="center"}
knitr::include_graphics("plot-n-vs-shape.1-mle_plot-n-vs-shape.3-mle.png")
```
...
```{r fig-n-vs-cp, echo=F, out.width="60%", fig.align="center"}
knitr::include_graphics("plot-n-vs-cp_n_vs_convergence.png")
```
