...
create_plots_for(plot_loess, n=100, p=0, q=1, data=data, prob_lo=0.0, prob_hi=0.4, remove_outliers=False)
create_plots_for(plot_loess, n=100, p=.215, q=.825, data=data, prob_lo=0.0, prob_hi=0.4, remove_outliers=False)
