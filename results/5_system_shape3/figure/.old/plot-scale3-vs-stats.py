...
data = pd.read_csv('./results/5_system_theta/bca/merge/boot-prob-shape3-very-base.csv')

params = ['scales.1', 'shapes.1', 'scales.2', 'shapes.2', 'scales.3', 'shapes.3']
param_labels = ['$\lambda_1$', '$k_1$', '$\lambda_2$', '$k_2$', '$\lambda_3$', '$k_3$']
...
plt.savefig('/home/spinoza/github/private/proj/results/MTTF/plot-scale3-vs-stats-2.pdf')
