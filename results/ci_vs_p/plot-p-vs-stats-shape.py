...
shape_params = ['shapes.2', 'shapes.3', 'shapes.4']
shape_param_labels = ["k_2", "k_3", "k_4"]
...
# Show the plot
#plt.show()
plt.savefig('plot-p-vs-stats-shape-n90.png', dpi=100)
plt.savefig('plot-p-vs-stats-shape-n90.pdf', dpi=300)
