...
def plot_mles_and_cis(ax, data_p, true_params, param, param_label):
    ...
    for i, p in enumerate(p_values):
        ...
        print("lower_q3 = {}, upper_q1 = {}".format(lower_q3, upper_q1))
    ...
    # Connect the means of the MLEs with a line
...
data = pd.read_csv('./results/5_system_ci_vs_p/data-boot-tau-fixed-bca-p-vs-ci-large-b-base.csv', na_values='NA')
...
plt.savefig('plot-p-vs-stats-shape-n90-large.png', dpi=100)
plt.savefig('plot-p-vs-stats-shape-n90-large.pdf', dpi=300)
