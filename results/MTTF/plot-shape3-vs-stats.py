...
def compute_stats(data, true_value, indep_col, param, true_value_is_col = False, remove_outliers = False):
    ...
    for val in values:
        ...
        if remove_outliers:
            data_s = remove_outliers_iqr(data_s, param, 10)
            data_s = remove_outliers_iqr(data_s, param_lower, 10)
            data_s = remove_outliers_iqr(data_s, param_upper, 10)
...
data = pd.read_csv('/home/spinoza/github/private/proj/results/MTTF/data-boot-mttf-shape3-vary-all.csv')
...
plt.savefig('/home/spinoza/github/private/proj/results/MTTF/plot-shape3-vs-stats-all.pdf')
