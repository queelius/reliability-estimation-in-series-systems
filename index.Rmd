...
The log-likelihood contribution of the $i$\textsuperscript{th} system is given by
\begin{equation}
...
The gradient of the log-likelihood contribution of the $i$\textsuperscript{th} system is given by
\begin{equation}
...
knitr::include_graphics(paste0("image/5_system_tau_fig.", if (knitr::is_latex_output()) "pdf" else "png"))
```
...
knitr::include_graphics(paste0("image/5_system_prob_fig.", if (knitr::is_latex_output()) "pdf" else "png"))
```
...
knitr::include_graphics(paste0("image/5_system_samp_size_fig.", if (knitr::is_latex_output()) "pdf" else "png"))
```
