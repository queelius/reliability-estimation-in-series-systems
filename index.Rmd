...
## Component Cause of Failure {#comp_cause}
...
functions of the components. This result will be used in the Section \ref{like_model}
...
We use these results in the simulation study in Section \ref{sim_study}, where we
...
Likelihood Model for Masked Data {#like_model}
==================================================
...
As described in Section \ref{like_model}, we observe realizations of
...
producing a specific form of the likelihood model described in Section \ref{like_model},
...
## Likelihood Model {#sys_weibull_likelihood}
In Section \ref{like_model}, we discussed two separate kinds of likelihood
...
Simulation Study: Full Model {#sim_study}
================================
...
## Data Generating Process {#data_gen}
...
2. Simulate $R \geq 300$ datasets from the Data Generating Process (DGP) described in
   Section \ref{data_gen} and compute an MLE for each dataset. We choose $R$ to be
...
Section \ref{sim_study}. Here, our focus shifts to a sensitivity
...
Bernoulli Candidate Set Model {#app-cand-model}
=============================
