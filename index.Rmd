...
- We fix the right-censoring quantile $q$ to $0.825$, which means the probability
of a right-censoring event is $17.5\%$, which is less than the masking probability.
...
- We fix the masking probability to $p = 21.5\%$.
