...
and that the probability that the $j$\textsuperscript{th} component is the cause of
failure is the expected value of the ratio of the hazard function of the
$j$\textsuperscript{th} component to the sum of the hazard functions of all
components.
